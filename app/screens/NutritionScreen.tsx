        ...
        <div className="max-w-md mx-auto space-y-4">
          ...
          >
            ...
            {Object.keys(meals).length > 0 && (
              ...
              >
                <h3 className="text-lg font-bold text-gray-800 mb-3">ארוחות היום</h3>
                {Object.entries(meals).map(([mealType, mealData]: [string, MealData]) => (
                  <motion.div
                    key={mealType}
                    initial={{ opacity: 0, scale: 0.95 }}
                    animate={{ opacity: 1, scale: 1 }}
                  ...
                  >
                    ...
                    <div className="grid grid-cols-4 gap-2 text-center">
                      <div>
                        ...
                        <p className="font-bold text-sm">{mealData.proteins}g</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">פחמימות</p>
                        <p className="font-bold text-sm">{mealData.carbs}g</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">שומנים</p>
                        <p className="font-bold text-sm">{mealData.fats}g</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">קלוריות</p>
                        <p className="font-bold text-sm">{mealData.calories}</p>
                      </div>
                    </div>
                  </motion.div>
                ))}
