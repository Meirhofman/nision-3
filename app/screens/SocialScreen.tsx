...
export const SocialScreen = () => {
  ...
  return (
    ...
    >
      ...
      <div className="px-6 py-4 flex flex-col gap-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`p-3 shadow-lg border rounded-full text-pink-500 hover:scale-105 transition-transform ${darkMode ? 'bg-slate-700 border-slate-600' : 'bg-white border-gray-100'}`}
          >
      ...
      {/* Tabs */}
      <div className={`flex gap-2 px-4 py-3 overflow-x-auto border-b ${darkMode ? 'bg-slate-700 border-slate-600' : 'bg-gray-50 border-gray-100'}`}>
        <button
